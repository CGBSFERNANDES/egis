...
export default {
  async montarProcedimento(cd_empresa, cd_cliente, nm_identificacao_api, nm_parametro_api) {
    try {
      ...
      var cd_movimento = localStorage.cd_movimento
      var cd_menu = localStorage.cd_menu
      var cd_etapa = localStorage.cd_etapa
      ...
      var cd_contato = localStorage.cd_contato
      ...
      var cd_vendedor = localStorage.cd_vendedor
      ...
      if (nm_parametro_api.indexOf('{cd_fornecedor}') != -1 && !cd_fornecedor == 0) {
      ...
      if (nm_parametro_api.indexOf('{nm_razao_social}') != -1 && !nm_razao_social == '') {
      ...
      if (nm_parametro_api.indexOf('{cd_identificacao}') != -1 && !cd_identificacao == '') {
      ...
      if (nm_parametro_api.indexOf('{nm_documento}') != -1 && !nm_documento == '') {
        sParametro = sParametro + `/${nm_documento}`
        ////ALERT('nm_razao_social');
      }

      if (nm_parametro_api.indexOf('{cd_empresa_usuario}') != -1 && !cd_empresa_usuario == 0) {
        sParametro = sParametro + `/${cd_empresa_usuario}`
        // //ALERT(localStorage.nm_fantasia);
      }

      if (nm_parametro_api.indexOf('{cd_tipo_filtro}') != -1 && !cd_tipo_filtro == '') {
        sParametro = sParametro + `/${cd_tipo_filtro}`
        //ALERT('CD_TIPO_FILTRO: ' + cd_tipo_filtro);
      }

      if (nm_parametro_api.indexOf('{cd_documento}') != -1 && !cd_documento == '') {
      ...
      //CD_CNPJ_CPF
      if (nm_parametro_api.indexOf('{cd_cnpj_cpf}') != -1 && !cd_cnpj_cpf == '') {
      ...
      if (nm_parametro_api.indexOf('{cd_filtro}') != -1 && !cd_filtro == '') {
        sParametro = sParametro + `/${cd_filtro}`
        // //ALERT(cd_filtro);
      }

      if (nm_parametro_api.indexOf('{vl_contrato}') != -1 && !vl_contrato == '') {
        sParametro = sParametro + `/${vl_contrato}`
        ////ALERT(vl_contrato);
      }

      if (nm_parametro_api.indexOf('{qt_apontamento}') != -1 && !qt_apontamento == '') {
      ...
      if (nm_parametro_api.indexOf('{dt_processo}') != -1 && !dt_processo == '') {
        sParametro = sParametro + `/${dt_processo}`
      }

      if (nm_parametro_api.indexOf('{cd_movimento}') != -1 && !cd_movimento == '') {
        sParametro = sParametro + `/${cd_movimento}`
      }

      if (nm_parametro_api.indexOf('{cd_entregador}') != -1 && !cd_entregador == '') {
        sParametro = sParametro + `/${cd_entregador}`
        //ALERT('CD_TIPO_FILTRO: ' + cd_tipo_filtro);
      }

      if (nm_parametro_api.indexOf('{cd_item_documento}') != -1 && !cd_item_documento == '') {
        sParametro = sParametro + `/${cd_item_documento}`
        //ALERT('CD_TIPO_FILTRO: ' + cd_tipo_filtro);
      }

      if (nm_parametro_api.indexOf('{cd_tipo_documento}') != -1 && !cd_tipo_documento == '') {
      ...
      if (nm_parametro_api.indexOf('{cd_etapa_origem}') != -1 && !cd_etapa_origem == '') {
        sParametro = sParametro + `/${cd_etapa_origem}`
        //ALERT('CD_TIPO_FILTRO: ' + cd_tipo_filtro);
      }
      if (nm_parametro_api.indexOf('{cd_etapa_destino}') != -1 && !cd_etapa_destino == '') {
        sParametro = sParametro + `/${cd_etapa_destino}`
        //ALERT('CD_TIPO_FILTRO: ' + cd_tipo_filtro);
      }
      //Empresa Faturamento
      if (nm_parametro_api.indexOf('{cd_empresa_fat}') != -1 && !cd_empresa_fat == 0) {
      ...
      if (nm_parametro_api.indexOf('{cd_tipo_parametro}') != -1 && !cd_tipo_parametro == '') {
        sParametro = sParametro + `/${cd_tipo_parametro}`
        //ALERT('CD_TIPO_FILTRO: ' + cd_tipo_filtro);
      }

      if (nm_parametro_api.indexOf('{cd_tipo_email}') != -1 && !cd_tipo_email == '') {
        sParametro = sParametro + `/${cd_tipo_email}`
        //ALERT('CD_TIPO_FILTRO: ' + cd_tipo_filtro);
      }

      if (nm_parametro_api.indexOf('{cd_contato}') != -1 && !cd_contato == '') {
        sParametro = sParametro + `/${cd_contato}`
        //ALERT('CD_TIPO_FILTRO: ' + cd_tipo_filtro);
      }

      if (nm_parametro_api.indexOf('{ds_parametro}') != -1 && !ds_parametro == '') {
        sParametro = sParametro + `/${ds_parametro}`
        //ALERT('CD_TIPO_FILTRO: ' + cd_tipo_filtro);
      }

      if (nm_parametro_api.indexOf('{cd_relatorio}') != -1 && !cd_relatorio == '') {
      ...
      if (nm_parametro_api.indexOf('{cd_comanda}') != -1 && !cd_comanda == '') {
        sParametro = sParametro + `/${cd_comanda}`
        //ALERT('CD_TIPO_FILTRO: ' + cd_tipo_filtro);
      }

      if (nm_parametro_api.indexOf('{cd_vendedor}') != -1 && !cd_vendedor == '') {
      ...
      if (nm_parametro_api.indexOf('{cd_tabela_preco}') != -1 && !cd_tabela_preco == '') {
      ...
      if (err.response?.status === 500) {
        console.error('Erro 500 capturado via Axios:', err.response?.data || err.message)
        return []
      }
