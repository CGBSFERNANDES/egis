<template>
  <div>
    <h2 class="content-block">Pesquisa de Contatos</h2>

    <div class="content-block dx-card responsive-paddings labels-pesquisa">
      <dx-form
        id="form"
        label-location="top"
        :form-data="formData"
      ...
      <div class="buttons-column buttom-pesquisa">
        <DxButton
          width="145"
          icon="find"
          text="Pesquisar"
...
export default {
  ...
  methods: {
    ...
    onClick(e) {
      ...
      notify(`Aguarde... vamos ${this.capitalize(buttonText)} os Contatos !`);
      ...
      if (!this.formData.RazaoSocial == "") {
        localStorage.nm_razao_social = this.formData.RazaoSocial;
      }

      if (!this.formData.Contato == "") {
        localStorage.nm_fantasia = this.formData.Contato;
      }
