...
export default {
  ...
  methods: {
    ...
    async showMenu() {
      ...
      ////console.log(this.cd_menu_detalhe);
      ////console.log(this.cd_api_detalhe);

      ////console.log(this.cd_detalhe);
    ...
    async onCellPrepared(e) {
      ...
      if (e.data != undefined) {
        if (e.data.cd_prioridade == 3 && e.rowType == "data") {
