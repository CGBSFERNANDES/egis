<template>
  <div>
    ...
    <DxDataGrid
      ...
      @editing-start="eventoRegistro('Alterando Registro')"
...
export default {
  ...
  methods: {
    ...
    inclusao: async function (e) {
      ...
      //console.log(e.data,'DADOS INCLUSAO')

      dados = await Incluir.incluirRegistro(apiCrud, e.data); //Falta API para fazer o CRUD
    ...
    alteracao: async function (e) {
      ...
      //console.log(e.data,'DADOS alteracao')
      //Carrega novamente os Dados Da grid
      this.carregaDados();
      //
    },
