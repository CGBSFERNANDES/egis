<template>
 <div>
    <h2 class="content-block">Previsão de Entrada</h2>
...
export default {
  ...
  methods: {
    ...
    onClick(e) {
      ...
      notify(`Aguarde... vamos ${this.capitalize(buttonText)} os Produtos !`);
      ...
      if (!this.formData.Nome == '') {
        localStorage.nm_produto = this.formData.Nome;
      }

      if (!this.formData.Fantasia == '') {
        localStorage.nm_fantasia_produto = this.formData.Fantasia;
      }
