<template>
  <div>
    ...
    <div>
          ...
          >
            <template v-slot:before>
              <div class="q-pa-md">
                <dx-data-grid
                  v-if="qt_tabsheet == 0"
                  class="dx-card wide-card grid-padrao"
      ...
      <div v-if="qt_registro > 0" class="row col for-Grid">
        <!--Onde os cards são renderizados com v-for-->
        <grid
          v-for="n in dataSourceConfig"
          v-bind:key="n"
          id="scrollbar"
          :cd_menuID="n.cd_menu_composicao"
          :cd_apiID="n.cd_api"
          :cd_parametroID="n.cd_parametro"
          :cd_dado_painelID="n.cd_dado_painel"
          :nm_tituloID="n.nm_titulo_painel"
          :nm_graficoID="n.nm_titulo_grafico"
          :cd_tipo_graficoID="n.cd_tipo_grafico"
          :cd_usuarioID="0"
          :cd_consulta="0"
          ref="grid_c"
        >
...
import grid from "../views/gridGrafico.vue";
...
export default {
  data() {
    return {
      ...
      tituloData: "SeleÃ§Ã£o de PerÃ­odo",
      taskDetails: "",
      temD: false,
      temPanel: false,
      qt_tabsheet: 0,
  ...
  methods: {
    ...
    async showMenu() {
      ...
      localStorage.cd_parametro = this.cd_menu;
      //
    ...
    async carregaDados() {
      ...
      if (this.qt_tabsheet == 0 && this.iproc == 0) {
    ...
    onClickData(e) {
      ...
      notify(`Aguarde... vamos ${this.capitalize(buttonText)}, aguarde !`);
    ...
    onClickExportar() {
      ...
      if (this.ds_arquivo == null) {
        notify("Arquivo nÃ£o encontradao ou sem informaÃ§Ãµes!");
        //this.ds_arquivo = 'Arquivo Texto sem informaÃ§Ãµes !'
        //const data = this.ds_arquivo;
    ...
    renderDoc() {
      ...
      loadFile("/Template_GBS.docx", function(
        ...
        if (error) {
          alert("nÃ£o encontrei o template.docx");
          throw error;
        }
