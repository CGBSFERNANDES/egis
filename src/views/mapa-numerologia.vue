<template>
 <div>
    <h2 class="content-block">Mapa</h2>
...
export default {
  ...
  methods: {
    ...
    onClick(e) {
      ...
      notify(`Aguarde... vamos ${this.capitalize(buttonText)} os dados para você !`);
            
      localStorage.nm_razao_social = 'null';      
      localStorage.dt_base         = 'null';
      ...
      if (!this.formData.Nascimento == '') {
        localStorage.dt_base = '07-30-1969';
      }
