<template>
  <div style="background: white">
    ...
    <div class="row items-center margin1">
      ...
      <div class="col" v-if="ic_mostra_selecao_data">
        <transition name="slide-fade">
          <q-btn
            style="float: right"
            round
        ...
        <div v-if="tipo_pesquisa_produto == 'S'" class="col">
          <div class="row margin1">
            ...
            <q-select
              dense
              class="umQuartoTela margin1"
              v-model="fase_produto_pesquisa"
              :options="dataset_lookup_fase_produto"
    ...
    <transition name="slide-fade">
      <div v-if="dataSourceConfig.length > 0">
        ...
        <dx-data-grid
          ...
          @row-dbl-click="SelecionaProduto()"
        >
        ...
        >
          ...
          <div v-if="dataSourceFornecedorProduto.length > 0">
            <dx-data-grid
              ...
              @focused-row-changed="RowChangedFornecedorProduto"
            >
              <DxGroupPanel :visible="true" empty-panel-text="agrupar..." />
      ...
      if (this.ic_comprado) {
        ...
        if (this.tipo_pesquisa_produto == "S") {
          JSON_Pesquisa = {
            ...
            cd_fase_produto: this.fase_produto_pesquisa.cd_fase_produto,
