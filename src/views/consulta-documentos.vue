...
export default {
  ...
  methods: {
    ...
    onFocusedRowChanged: function (e) {
      ...
      this.linha_doc = e.row && e.row.data;
    ...
    async carregaDados() {
      ...
      this.dataSourceConfig = await Incluir.incluirRegistro(
        "606/844", //this.api, //pr_egisnet_crud_documentos
        json_consulta
      );
    ...
    async onDownloadDoc() {
      ...
      try {
        const options = {
          method: "GET",
          responseType: "blob",
          url: `https://egis-store.com.br/api/download/${this.linha_doc.nm_caminho_documento}/${localStorage.nm_ftp_empresa}/${this.linha_doc.nm_pasta_ftp}`,
        };
        await axios(options)
          .then((response) => {
          ...
          .catch((error) => {
            ...
            notify("Não foi possível baixar o documento");
          });
