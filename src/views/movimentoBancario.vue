<template>
  <div>
    <div class="margin1 titulo-bloco">Movimento Bancário</div>
    <q-tabs
      v-model="tab"
      class="text-orange-9"
      dense
    ...
    <q-tab-panels v-model="tab" animated>
      <q-tab-panel name="dados">
        GRID COM TODOS MOVIMENTOS BANCÁRIOS
      ...
      <q-tab-panel name="cadastro">
        ...
        <div class="row">
          <q-input dense class="col margin1" v-model="text" label="Empresa"
            ><template v-slot:prepend>
              <q-icon name="store" class="cursor-pointer"></q-icon>
            </template>
          </q-input>
          <q-input dense class="col margin1" v-model="text" label="Histórico"
            ><template v-slot:prepend>
        ...
        <div class="row">
          <q-input dense class="col margin1" v-model="text" label="Saída"
            ><template v-slot:prepend>
              <q-icon name="logout" class="cursor-pointer"></q-icon>
            </template>
          </q-input>
          ...
          <q-input dense class="col margin1" v-model="text" label="Conciliado"
            ><template v-slot:prepend>
        ...
        <div class="row">
          ...
          <q-input dense class="col margin1" v-model="text" label="Lançamento"
            ><template v-slot:prepend>
