...
>
  ...
  <dx-pager
    ...
    :show-info="true"
  />
     <template slot="acoesTemplate" slot-scope="cellCtx">
  <div class="row no-wrap items-center justify-center">
    <q-btn
      dense flat round icon="edit" color="deep-purple-7"
      @click.native.stop="editarItem(cellCtx && (cellCtx.data || cellCtx))"
    >
      <q-tooltip>Editar</q-tooltip>
    </q-btn>
    <q-btn
      dense flat round icon="delete" color="negative"
      @click.native.stop="removerItem(((cellCtx && (cellCtx.data || cellCtx)) || {}).__rowid)"
    >
