...
IF OBJECT_ID(N'dbo.pr_egis_servicos_processo_modulo', N'P') IS NOT NULL
    DROP PROCEDURE dbo.pr_egis_servicos_processo_modulo;
GO


-------------------------------------------------------------------------------
--sp_helptext  pr_egis_servicos_processo_modulo
-------------------------------------------------------------------------------
...
CREATE PROCEDURE pr_egis_servicos_processo_modulo
------------------------------------------------------------------------------
@json nvarchar(max) = ''
------------------------------------------------------------------------------
--with encryption
...
begin
  --select @cd_empresa
  exec pr_controle_contrato_servico 1,'',@dt_inicial, @dt_final, 0, @dt_hoje
...
------------------------------------------------------------------------------
--exec  dbo.pr_egis_servicos_processo_modulo
------------------------------------------------------------------------------
--use egissql
--go
--use egissql
...
--exec  dbo.pr_egis_servicos_processo_modulo '[{"cd_parametro": 0 }]' 
--exec  dbo.pr_egis_servicos_processo_modulo '[{"cd_parametro": 1, "cd_usuario": 113 }]' 
go
--exec  dbo.pr_egis_servicos_processo_modulo '[{"ic_json_parametro": "S", "cd_parametro": 2, "cd_usuario": 113 }]' 
