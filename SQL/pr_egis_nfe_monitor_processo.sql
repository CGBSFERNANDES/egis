...
IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_nfe_monitor_processo' 
	   AND 	  type = 'P')
    DROP PROCEDURE  pr_egis_nfe_monitor_processo
...
IF OBJECT_ID('pr_egis_nfe_monitor_processo','P') IS NOT NULL
    DROP PROCEDURE pr_egis_nfe_monitor_processo;
GO
...
------------------------------------------------------------------------------
--exec  pr_egis_nfe_monitor_processo
------------------------------------------------------------------------------
...
go
/*
exec  pr_egis_nfe_monitor_processo '[{"cd_parametro": 0}]'
exec  pr_egis_nfe_monitor_processo '[{"cd_parametro": 1, "cd_modelo": 1}]'                                           ]'
*/
go
------------------------------------------------------------------------------
GO
