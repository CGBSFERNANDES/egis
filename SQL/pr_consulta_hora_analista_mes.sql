...
--Objetivo            : Consultar horas de visitas por analista e mes
--Data                : 20/03/04
...
IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_consulta_hora_analista_mes' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_consulta_hora_analista_mes
GO
...
-- =============================================
--EXECUTE pr_consulta_hora_analista_mes '01/01/04', '02/29/04'
-------------------------------------------------------------------