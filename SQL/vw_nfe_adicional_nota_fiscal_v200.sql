...
select
  ...
  ltrim(rtrim(cast(substring(ns.ds_obs_compl_nota_saida,1,250)   as varchar(250))))   as 'infCpl', 
  ltrim(rtrim(cast(substring(ns.ds_obs_compl_nota_saida,1,250)   as varchar(250))))   as 'infCpf',
