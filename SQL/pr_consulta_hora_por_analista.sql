...
--Objetivo                 : Consultar horas de visitas em clientes por analista
--Data                     : 20/03/04
...
IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_consulta_hora_por_analista' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_consulta_hora_por_analista
GO
...
-- =============================================
--EXECUTE pr_consulta_hora_por_analista '01/01/04', '03/31/04'
----------------------------------------------------------------
GO