...
IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_vendas_tipo_pedido' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_vendas_tipo_pedido

GO

-------------------------------------------------------------------------------
--sp_helptext pr_egis_vendas_tipo_pedido
-------------------------------------------------------------------------------
--pr_egis_vendas_tipo_pedido
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_egis_vendas_tipo_pedido
@json nvarchar(max) = ''
...
set @cd_documento = ISNULL(@cd_documento,0)
  ...
  SELECT 
    ...
    max(tpe.nm_tipo_pedido)                  as nm_tipo_pedido,
...
go
--exec pr_egis_vendas_tipo_pedido '[{"dt_inicial":"06/01/2025"}, {"dt_final":"06/30/2025"}]'
go
