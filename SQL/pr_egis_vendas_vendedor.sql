...
IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_vendas_vendedor' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_vendas_vendedor

GO

-------------------------------------------------------------------------------
--sp_helptext pr_egis_vendas_vendedor
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_egis_vendas_vendedor
@json nvarchar(max) = ''
...
set @cd_documento = ISNULL(@cd_documento,0)
  ...
  SELECT 
    ...
    max(v.nm_fantasia_vendedor)              as nm_tipo_pedido,
...
--use EGISSQL_342
--go
--exec pr_egis_vendas_vendedor '[{"dt_inicial":"06/01/2025"}, {"dt_final":"06/30/2025"}]'
--go
