IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_relatorio_faturamento_mensal' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_relatorio_faturamento_mensal
...
--
------------------------------------------------------------------------------
create procedure pr_egis_relatorio_faturamento_mensal
@cd_relatorio int   = 0,
@cd_usuario   int   = 0,
@cd_parametro int   = 0,
@json nvarchar(max) = '' 
