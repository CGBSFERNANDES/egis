...
-------------------------------------------------------------------------------
--GBS Global Business Solution Ltda                                        20243426
-------------------------------------------------------------------------------
...
if @cd_relatorio = 437
begin
	exec pr_egis_relatorio_prestacao_conta @json = @json
	return
end
...
if @cd_relatorio = 434
begin
   set @jsonParam = '[{"cd_ordem_servico": '+cast(@cd_documento as varchar(80))+
                    ', "cd_usuario": '+cast(@cd_usuario as varchar(80))+'}]'

	exec pr_egis_relatorio_ordem_servico_consultoria @jsonParam 
	return
end
...
begin
   set @jsonParam = '[{"cd_ordem_servico": '+cast(@cd_documento as varchar(80))+
                    ', "cd_usuario": '+cast(@cd_usuario as varchar(80))+'}]'
  exec pr_egis_relatorio_ordem_servico_grafica @json
  return
end
...
if @cd_relatorio = 431
begin
  exec pr_egis_relatorio_contrato_vigente @json
  return
end
...
if @cd_relatorio = 430
begin
	exec pr_egis_relatorio_desconto_documentos @json
	return
end
...
if @cd_relatorio = 427
begin
	exec pr_egis_relatorio_resumo_comissao_vendedor @json = @json
	return
end
...
begin
    --select @json
	exec pr_egis_relatorio_remessa_documentos @json
	return
end
...
if @cd_relatorio = 421  
begin   
 exec pr_egis_relatorio_nota_servico @json  
 return  
end  
...
if @cd_relatorio = 405
begin 
	exec pr_egis_relatorio_contabiliza_documentos_pagar @cd_relatorio,@cd_parametro,@json
	return
end
...
if @cd_relatorio = 59
begin
  exec pr_egis_relatorio_contabiliza_documentos_receber @cd_relatorio,@cd_parametro,@json
  return
end
