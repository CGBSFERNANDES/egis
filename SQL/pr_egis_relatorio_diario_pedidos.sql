IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_relatorio_diario_pedidos' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_relatorio_diario_pedidos

GO

-------------------------------------------------------------------------------
--sp_helptext pr_egis_relatorio_diario_pedidos
-------------------------------------------------------------------------------
--pr_egis_relatorio_diario_pedidos
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_egis_relatorio_diario_pedidos
@cd_relatorio int   = 0,
@cd_usuario   int   = 0,
@json nvarchar(max) = '' 
...
where
  ...
  and
  p.dt_pedido_venda = @dt_pedido_venda
  and
...
while exists ( select cd_controle from #Separacao )
begin
  ...
  select top 1
    ...
    @html_detalhe = @html_detalhe + '
            <tr> 					
            <td style="font-size:12px; text-align:center;width: 20px">'+hr_inicial_pedido+'</td>
			<td style="font-size:12px; text-align:center;width: 20px">'+cast(cd_pedido_venda as varchar(9))+'</td>
			<td style="font-size:12px; text-align:center;width: 20px">'+dbo.fn_data_string(dt_pedido_venda)+'</td>
			<td style="font-size:12px; text-align:center;width: 20px">'+cast(nm_tipo_pedido as varchar(20))+'</td>	
			...
			<td style="font-size:12px; text-align:center;width: 20px">'+cast(ic_ordsep_pedido_venda as varchar(10))+'</td>	
			<td style="font-size:12px; text-align:center;width: 20px">'+cast(nm_fantasia_empresa as varchar(30))+'</td>	
			<td style="font-size:12px; text-align:center;width: 20px">'+cast(nm_fantasia_usuario as varchar(30))+'</td>	
			<td style="font-size:12px; text-align:center;width: 20px">'+dbo.fn_formata_valor(vl_total_pedido)+'</td>	
			<td style="font-size:12px; text-align:center;width: 20px">'+cast(nm_cidade as varchar(60))+'</td>	
            </tr>'
...
------------------------------------------------------------------------------
exec pr_egis_relatorio_diario_pedidos 165,''
------------------------------------------------------------------------------
