IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'vw_nfe_ipi_nota_fiscal' 
	   AND 	  type = 'V')
    DROP VIEW vw_nfe_ipi_nota_fiscal
GO
...
------------------------------------------------------------------------------------
--Testando a View
--select vl_base_ipi_item, pc_ipi, vl_ipi from nota_saida_item where cd_nota_saida = 23628 
------------------------------------------------------------------------------------
--select top 1000 * from vw_nfe_ipi_nota_fiscal where cd_nota_saida = 23628
------------------------------------------------------------------------------------
