IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'vw_nfe_imposto_importacao_nota_fiscal' 
	   AND 	  type = 'V')
    DROP VIEW vw_nfe_imposto_importacao_nota_fiscal
GO
...
-- Testando a View
------------------------------------------------------------------------------------
--select top 1000 * from vw_nfe_imposto_importacao_nota_fiscal
------------------------------------------------------------------------------------
