    ...
    */
    ...
    cast(((isnull(nsi.vl_total_item,0)+
          ...
          (isnull(nsi.vl_pis,0)+
           ...
           isnull(nsi.vl_difal,0))) as decimal(15,2))            as vBC,     -- Base IBS/CBS do item
    ...
    then
      ...
      CAST(((isnull(nsi.vl_total_item,0)+
           ...
           (isnull(nsi.vl_pis,0)+
            isnull(nsi.vl_cofins,0)+
            isnull(nsi.vl_icms_item,0)+
            isnull(nsi.vl_difal,0))) * 0.1/100 as decimal(15,2)) 
    ...
    then
      ...
      CAST(((isnull(nsi.vl_total_item,0)+
            ...
            (isnull(nsi.vl_pis,0)+
             isnull(nsi.vl_cofins,0)+
             isnull(nsi.vl_icms_item,0)+
             isnull(nsi.vl_difal,0))) * 0.9/100 AS decimal(15,2)) 
...
-- Testando a View
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--select * from vw_nfe_cibs_imposto_api  where cd_nota_saida = 7321
------------------------------------------------------------------------------------------------------------------------------------------------------------------------