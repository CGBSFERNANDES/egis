...
select
  ...
  isnull(CONVERT(varchar, convert(numeric(14,2),round(nsi.pc_reducao_icms,6,2)),103),'0.00')         as 'pREDBC',
...
------------------------------------------------------------------------------------
--select top 1000 * from vw_nfe_icms_nota_fiscal WHERE cd_nota_saida = 3080
