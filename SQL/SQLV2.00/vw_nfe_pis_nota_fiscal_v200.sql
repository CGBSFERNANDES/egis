IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'vw_nfe_pis_nota_fiscal' 
	   AND 	  type = 'V')
    DROP VIEW vw_nfe_pis_nota_fiscal
GO

CREATE VIEW vw_nfe_pis_nota_fiscal
------------------------------------------------------------------------------------
--sp_helptext vw_nfe_pis_nota_fiscal
------------------------------------------------------------------------------------
...
select
  ...
  'Q'                                                            as 'PIS',
  'Q02'                                                          as 'PISAliq',
  ltrim(rtrim(cast(ti.cd_digito_tributacao_pis as varchar(2))))  as 'CST',
...
-- Testando a View
------------------------------------------------------------------------------------
--select top 1000 * from vw_nfe_pis_nota_fiscal
------------------------------------------------------------------------------------
