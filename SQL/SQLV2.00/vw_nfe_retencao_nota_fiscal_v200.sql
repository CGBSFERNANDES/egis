IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'vw_nfe_retencao_nota_fiscal' 
	   AND 	  type = 'V')
    DROP VIEW vw_nfe_retencao_nota_fiscal
GO
...
-- Testando a View
------------------------------------------------------------------------------------
--select top 1000 * from vw_nfe_retencao_nota_fiscal where cd_nota_saida = 58880
---------------------------------------------------------------------------------1---
--select * from nota_saida where cd_nota_saida = 58871
