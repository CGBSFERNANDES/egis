IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'vw_nfe_cofins_nota_fiscal' 
	   AND 	  type = 'V')
    DROP VIEW vw_nfe_cofins_nota_fiscal
GO
...
-- Testando a View
------------------------------------------------------------------------------------
--select top 1000 cd_digito_tributacao_cofins, * from vw_nfe_cofins_nota_fiscal
------------------------------------------------------------------------------------
--select * from tributacao_cofins
