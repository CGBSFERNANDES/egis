IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_relatorio_faturamento_anual' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_relatorio_faturamento_anual

GO

-------------------------------------------------------------------------------
--sp_helptext pr_egis_relatorio_faturamento_anual
-------------------------------------------------------------------------------
--pr_egis_relatorio_faturamento_anual
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_egis_relatorio_faturamento_anual
@cd_relatorio int   = 0,
@cd_usuario   int   = 0,
@cd_parametro int   = 0,
@json nvarchar(max) = '' 
...
---------------------------------------------------------------------------------------------------------------------------
 ...
 begin
    select * from  #FinalFaturamentoAnual
  return
 end
...
while exists( select Top 1 cd_controle from #FinalFaturamentoAnual )
begin
 ...
 delete from #FinalFaturamentoAnual
 where
   cd_controle = @id
...
set @html_totais = '<div class="section-title"><strong>'+@titulo_total+'</strong>
                    ...
                    <tr>										
					<p><b>&nbsp</p>
			        <p><b>Total de Clientes: '+cast(@qt_total as varchar(10))+'</p>
			        <p><b>Total:'+'R$ '+dbo.fn_formata_valor(@vl_total)+'</p>	
					</tr>
					</table>
					<div> 
					</div>
...
------------------------------------------------------------------------------
--exec pr_egis_relatorio_faturamento_anual 177,4253,0,''
------------------------------------------------------------------------------
