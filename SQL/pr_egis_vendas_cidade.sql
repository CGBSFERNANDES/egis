...
IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_vendas_cidade' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_vendas_cidade

GO

-------------------------------------------------------------------------------
--sp_helptext pr_egis_vendas_cidade
-------------------------------------------------------------------------------
--pr_egis_vendas_cidade
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_egis_vendas_cidade
@json nvarchar(max) = ''
...
set @cd_documento = ISNULL(@cd_documento,0)
  ...
  left outer join cidade cid                on cid.cd_estado       = c.cd_estado and
...
------------------------------------------------------------------------------
go
--exec pr_egis_vendas_cidade '[{"dt_inicial":"06/01/2025"}, {"dt_final":"06/30/2025"}]'
go
