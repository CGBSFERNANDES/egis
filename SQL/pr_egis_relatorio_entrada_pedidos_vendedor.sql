IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_relatorio_entrada_pedidos_vendedor' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_relatorio_entrada_pedidos_vendedor

GO

-------------------------------------------------------------------------------
--sp_helptext pr_egis_relatorio_entrada_pedidos_vendedor
-------------------------------------------------------------------------------
--pr_egis_relatorio_entrada_pedidos_vendedor
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_egis_relatorio_entrada_pedidos_vendedor
@cd_relatorio int   = 0,
@cd_usuario   int   = 0,
@cd_parametro int   = 0,
@json nvarchar(max) = '' 
...
if isnull(@cd_parametro,0) not in (1,2,3)
begin
...
set @html_totais = '<div>
			        ...
			        <p style="border: none;color: white;font-size:18px; text-align:left;"><b>'+cast(@qt_total as varchar(10))+'</p>
			        <p style="border: none;color: white;font-size:18px; text-align:left;"><b>'+'R$ '+dbo.fn_formata_valor(@vl_total)+'</p>	
					</tr>
					</table>					
					</div>'
...
------------------------------------------------------------------------------
--Gráfico
--exec pr_egis_relatorio_entrada_pedidos_vendedor 180,4253,0,''
------------------------------------------------------------------------------
