...
IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_validacao_acesso_usuario' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_validacao_acesso_usuario

GO
 -------------------------------------------------------------------------------  
--sp_helptext pr_egis_validacao_acesso_usuario  
-------------------------------------------------------------------------------  
...
create procedure pr_egis_validacao_acesso_usuario  
...
--Executando
----------------------------------------------------------------------------------------------  
--pr_egis_validacao_acesso_usuario 2,'carlos@gbstec.com.br','25022','carlos@gbstec.com.br',''
--
--pr_egis_validacao_acesso_usuario 1,'marcelcom@lufaed.com.br','57879','marcelcom@lufaed.com.br','P',0
--
--exec pr_egis_validacao_acesso_usuario 0,'carlos','@123','','P',0
--exec pr_egis_validacao_acesso_usuario 0,'sandracf','sandragbs','','P',0

--exec pr_egis_validacao_acesso_usuario 0,'Matheusrf','matheusrf','','P',0
