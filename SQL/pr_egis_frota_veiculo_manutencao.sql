...
IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_frota_veiculo_manutencao' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_frota_veiculo_manutencao

GO

-------------------------------------------------------------------------------
--sp_helptext pr_egis_frota_veiculo_manutencao
-------------------------------------------------------------------------------
--pr_egis_frota_veiculo_manutencao
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_egis_frota_veiculo_manutencao
@json nvarchar(max) = ''
...
set @cd_documento = ISNULL(@cd_documento,0)
  ...
  SELECT 
	...
	count(distinct i.cd_tipo_servico_veiculo)   as qt_tipo_servico
...
--use EGISSQL_247
--go
--exec pr_egis_frota_veiculo_manutencao '[{"dt_inicial":"06/01/2025"}, {"dt_final":"06/30/2025"}]'
--go
