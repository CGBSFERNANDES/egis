IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_faturamento_veiculo'
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_faturamento_veiculo

GO

-------------------------------------------------------------------------------
--sp_helptext pr_egis_faturamento_veiculo
-------------------------------------------------------------------------------
--pr_egis_faturamento_veiculo
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_egis_faturamento_veiculo
@json nvarchar(max) = ''
...
--use egissql_247
--go
--exec pr_egis_faturamento_veiculo '[{"cd_veiculo":0, "cd_parametro": 1,"cd_usuario":113, "dt_inicial": "06/01/2025", "dt_final": "06/30/2025"}]'
--go
------------------------------------------------------------------------------
