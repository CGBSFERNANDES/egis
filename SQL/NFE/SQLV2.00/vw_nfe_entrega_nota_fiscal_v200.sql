IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'vw_nfe_entrega_nota_fiscal' 
	   AND 	  type = 'V')
    DROP VIEW vw_nfe_entrega_nota_fiscal
GO
...
-- Testando a View
------------------------------------------------------------------------------------
--select top 1000 * from vw_nfe_entrega_nota_fiscal 
------------------------------------------------------------------------------------
--select top 1000 * from vw_nfe_entrega_nota_fiscal where cd_nota_saida = 1
--select * from nota_saida where cd_nota_saida = 1
