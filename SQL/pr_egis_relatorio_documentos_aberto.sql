IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_relatorio_documentos_aberto' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_relatorio_documentos_aberto

GO

-------------------------------------------------------------------------------
--sp_helptext pr_egis_relatorio_documentos_aberto
-------------------------------------------------------------------------------
--pr_egis_relatorio_documentos_aberto
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_egis_relatorio_documentos_aberto
@cd_relatorio int   = 0,
@cd_parametro int   = 0,
@json nvarchar(max) = '' 
...
------------------------------------------------------------------------------
--exec pr_egis_relatorio_documentos_aberto 255,0,''
------------------------------------------------------------------------------
