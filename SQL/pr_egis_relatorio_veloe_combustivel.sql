IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_relatorio_veloe_combustivel' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_relatorio_veloe_combustivel

GO
  
-------------------------------------------------------------------------------  
--sp_helptext pr_egis_relatorio_veloe_combustivel  
-------------------------------------------------------------------------------  
--pr_egis_relatorio_veloe_combustivel  
-------------------------------------------------------------------------------  
...
--  
------------------------------------------------------------------------------  
create procedure pr_egis_relatorio_veloe_combustivel
@cd_relatorio int   = 0,  
@cd_parametro int   = 0,  
@json nvarchar(max) = ''   
...
WHILE EXISTS (SELECT TOP 1 cd_controle FROM #VeloeCombustivel)  
BEGIN  
    SELECT TOP 1  
        @id                          = cd_controle,  
	...
	FROM
	  #VeloeCombustivel  
    DELETE FROM #VeloeCombustivel WHERE cd_controle = @id  
END  
--------------------------------------------------------------------------------------------------------------------  
...
--exec pr_egis_relatorio_veloe_combustivel 305,0,''