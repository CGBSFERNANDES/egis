...
order by
  ...
  "data": [
    {
      "idFilial": "B5",
      "cnpjFilial": "05828732001917",
      "nomeFilial": "SHOPPING GRANJA VIANA 2",
      "razaosocialFilial": "SHOPPING GRANJA VIANA 2",
      "chaveNotaFiscal": "35250705828732001917550400000013531100000004",
      "numeroNotaFiscal": "000001353",
      "serieNotaFiscal": "40",
      "dataEmissaoNotaFiscal": "2025/07/28",
      "valorNotaFiscal": "13",
      ...
      "itensNotaFiscal": [
        {
          "codProduto": "107319",
          "descProduto": "Não informado",
          "quantProduto": "1",
          "valorProduto": "13",
          "codUnidadeProduto": "UN",
          "valorUnitario": "13",
          "idCFOP": "5405",
          "numeroItemNota": "01"
        }
...
begin
  ...
  select 
    ...
    cd_cnpj_cliente           as cnpj,
    nm_razao_social_cliente   as Nome
  from
    cliente
  where
    cd_status_cliente = 1
...
exec  pr_egis_exportacao_dados '[{"cd_parametro": 1, "cd_modelo": 1}]'                                           ]'
*/
go
------------------------------------------------------------------------------
GO
