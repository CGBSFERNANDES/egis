...
IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_vendas_empresa_faturamento' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_vendas_empresa_faturamento

GO

-------------------------------------------------------------------------------
--sp_helptext pr_egis_vendas_empresa_faturamento
-------------------------------------------------------------------------------
--pr_egis_vendas_empresa_faturamento
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_egis_vendas_empresa_faturamento
@json nvarchar(max) = ''
...
go
--exec pr_egis_vendas_empresa_faturamento '[{"dt_inicial":"06/01/2025"}, {"dt_final":"06/30/2025"}]'
go
