...
IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_vendas_estado' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_vendas_estado

GO

-------------------------------------------------------------------------------
--sp_helptext pr_egis_vendas_estado
-------------------------------------------------------------------------------
--pr_egis_vendas_estado
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_egis_vendas_estado
@json nvarchar(max) = ''
...
go
--exec pr_egis_vendas_estado '[{"dt_inicial":"06/01/2025"}, {"dt_final":"06/30/2025"}]'
go
