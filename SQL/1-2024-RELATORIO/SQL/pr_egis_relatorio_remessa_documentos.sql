IF OBJECT_ID('dbo.pr_egis_relatorio_remessa_documentos', 'P') IS NOT NULL
    DROP PROCEDURE dbo.pr_egis_relatorio_remessa_documentos;
GO

/*-------------------------------------------------------------------------------------------------
  pr_egis_relatorio_remessa_documentos
---------------------------------------------------------------------------------------------------
...
WITH (
    ...
    cd_conta_banco    INT         '$.cd_conta_banco'
        ...
        WHERE d.cd_remessa_banco = @cd_remessa_banco
