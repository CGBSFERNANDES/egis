IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_relatorio_dados_por_veiculo' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_relatorio_dados_por_veiculo

GO

-------------------------------------------------------------------------------
--sp_helptext pr_egis_relatorio_dados_por_veiculo
-------------------------------------------------------------------------------
--pr_egis_relatorio_dados_por_veiculo
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_egis_relatorio_dados_por_veiculo
@cd_relatorio int   = 0, 
@json nvarchar(max) = '' 
...
as
print 'iniciou a pr_egis_relatorio_dados_por_veiculo'
...
select 'Dados por Veículos' AS pdfName,isnull(@html,'') as RelatorioHTML
-------------------------------------------------------------------------------------------------------------------------------------------------------
go

--exec pr_egis_relatorio_dados_por_veiculo 366,''
