IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_relatorio_romaneio_embarque_nota_divisao' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_relatorio_romaneio_embarque_nota_divisao

GO
  
-------------------------------------------------------------------------------  
--sp_helptext pr_egis_relatorio_romaneio_embarque_nota_divisao  
-------------------------------------------------------------------------------  
--pr_egis_relatorio_romaneio_embarque_nota_divisao
-------------------------------------------------------------------------------  
...
--  
------------------------------------------------------------------------------  
create procedure pr_egis_relatorio_romaneio_embarque_nota_divisao
@cd_relatorio int   = 0,  
@cd_parametro int   = 0,  
@json nvarchar(max) = ''   
...
set @html_geral = ' 
		 ...
		 <p style="text-align: center;font-size: 15px;" > <b>Divisão - Romaneio de Embarque: '+CAST(ISNULL(@cd_carga_rel,0) AS nvarchar(20))+'</b></p>
            ...
            begin
        	 ...
        	 <div class="nao-quebrar">
        	  <table style="width: 100%;">
        		<tr class="tamanho" style="display: flex; flex-direction: column;color: #000000;border: 1px solid #000000aa;">
        		   <div style="display: flex; justify-content: space-between; align-items: flex-start; width: 100%;">
        		    <p style="width: 7%;">Código:'+CAST(ISNULL(cd_cliente,0) AS nvarchar(20))+' </p>	
        			<p style="width: 45%;text-align: left;">'+ISNULL(nm_razao_social_cliente,'')+'</p>
        			<p style="width: 32%;text-align: left;"><b>'+ISNULL(nm_fantasia_cliente,'')+'</b></p>
...
--exec pr_egis_relatorio_romaneio_embarque_nota_divisao 284,0,''