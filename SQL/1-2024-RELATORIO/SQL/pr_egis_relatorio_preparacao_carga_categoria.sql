IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_relatorio_preparacao_carga_categoria' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_relatorio_preparacao_carga_categoria

GO

-------------------------------------------------------------------------------
--sp_helptext pr_egis_relatorio_preparacao_carga_categoria
-------------------------------------------------------------------------------
--pr_egis_relatorio_preparacao_carga_categoria
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_egis_relatorio_preparacao_carga_categoria
@cd_relatorio int   = 0,
@cd_documento int   = 0,
@cd_parametro int   = 0,
@json nvarchar(max) = '' 
...
------------------------------------------------------------------------------
--exec pr_egis_relatorio_preparacao_carga_categoria 16,79630,0,''
------------------------------------------------------------------------------
