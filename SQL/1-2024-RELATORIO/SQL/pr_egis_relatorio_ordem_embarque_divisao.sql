IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_relatorio_ordem_embarque_divisao' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_relatorio_ordem_embarque_divisao

GO
  
-------------------------------------------------------------------------------  
--sp_helptext pr_egis_relatorio_ordem_embarque_divisao  
-------------------------------------------------------------------------------  
--pr_egis_relatorio_ordem_embarque_divisao
-------------------------------------------------------------------------------  
...
--  
------------------------------------------------------------------------------  
create procedure pr_egis_relatorio_ordem_embarque_divisao 
@cd_relatorio int   = 0,  
@cd_parametro int   = 0,  
@json nvarchar(max) = ''   
...
set @html_geral = '   
  <div style="display: flex; justify-content: space-between;">  
            ...
            <p><strong>Divis„o - Ordem de Embarque : </strong> '+CAST(ISNULL(@cd_carga_rel,0) AS nvarchar(20))+' </p>          
         </div>     
     
   <p style="text-align: center;font-size: 16px;" > <b>Divis„o - Ordem de Embarque '+CAST(ISNULL(@cd_carga_rel,0) AS nvarchar(20))+'</b></p>  
...
set @html_cab_det = @html_cab_det + '<p class="titulo"><b> Tipo de Pedido: '+ case when isnull(@id_ped_cab,0) >  0 then ''+ISNULL(@nm_tipo_agrupamento,'')+'' else '' end +'</b></p>  
             <div>  
              ...
              <p class="tamanho" style="width:5%"><b>C”DIGO</b></p>  
              <p class="tamanho" style="width:61%"><b>DESCRI«√O</b></p>  
...
--exec pr_egis_relatorio_ordem_embarque_divisao 284,0,''