IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egismob_relatorio_pedidos_venda_vendedor' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egismob_relatorio_pedidos_venda_vendedor

GO

-------------------------------------------------------------------------------
--sp_helptext pr_egismob_relatorio_pedidos_venda_vendedor
-------------------------------------------------------------------------------
--pr_egismob_relatorio_pedidos_venda_vendedor
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_egismob_relatorio_pedidos_venda_vendedor
@cd_relatorio int   = 0,
@cd_usuario   int   = 0,
@cd_parametro int   = 0,
@json nvarchar(max) = '' 
...
if @cd_usuario>0 and @cd_form <> 32 
...
begin
  ...
  --Total do Vendedor---------------------------
    ...
    set @html_cab_det = '<div class="section-title"><strong> '+'TIPO DE PEDIDO : '+isnull(@nm_tipo_pedidoV,'') + ' </strong></div>    
                     <table>
                     <tr>'
					 +
...
set @html_totais = '<div class="section-title"><strong>'+@titulo_total+'</strong>
			        ...
			        <td style="border: none;color: white;font-size:18px; text-align:center;width: 20px"><b>'+cast(isnull(@qt_total,0) as varchar(10))+'</td>
			        <td style="border: none;color: white;font-size:18px; text-align:left;width: 45px"><b>'+'R$ '+dbo.fn_formata_valor(isnull(@vl_total,0))+'</td>	
					</tr>
					</table>
					</div>
					</div>'
...
------------------------------------------------------------------------------
--exec pr_egismob_relatorio_pedidos_venda_vendedor 167,4374,0,'[{
--    "cd_menu": "0",
--    "cd_form": 32,
--    "cd_documento_form": 2,
--    "cd_parametro_form": "2",
--    "cd_usuario": "1368",
--    "cd_cliente_form": "0",
--    "cd_contato_form": "1368",
--    "dt_usuario": "2025-08-05",
--    "lookup_formEspecial": {},
--    "cd_parametro_relatorio": "2",
--    "cd_relatorio": "167",
--    "dt_inicial": "2025-08-04",
--    "dt_final": "2025-08-04",
--    "cd_empresa": null,
--    "cd_vendedor": 42,
--    "detalhe": [],
