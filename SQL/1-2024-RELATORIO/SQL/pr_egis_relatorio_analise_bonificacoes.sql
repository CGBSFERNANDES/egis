IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_relatorio_analise_bonificacoes' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_relatorio_analise_bonificacoes

GO

-------------------------------------------------------------------------------
--sp_helptext pr_egis_relatorio_analise_bonificacoes
-------------------------------------------------------------------------------
--pr_egis_relatorio_analise_bonificacoes
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_egis_relatorio_analise_bonificacoes
@cd_relatorio int   = 0,
@cd_usuario   int   = 0,
@cd_parametro int   = 0,
@json nvarchar(max) = '' 
...
begin
  ...
  --Dados da Tabela---
   ...
   set @tabela = '<div class="container mt-5">
    <h2 class="mb-4">'+'Bonificações, Trocas, Indenizações e Amostras'+'</h2>
...
set @html_totais = '<div>'+@titulo_total+'
					<table style="border: none;">
                    <tr>								
			          <p style="border: none;color: white;font-size:18px; text-align:left;"><b>Clientes: '+cast(@qt_total as varchar(10))+'</p>
			          <p style="border: none;color: white;font-size:18px; text-align:left;"><b>Total: '+'R$ '+dbo.fn_formata_valor(@vl_total)+'</p>
					</tr>
					</table>					
					</div>'
...
------------------------------------------------------------------------------
--Gráfico
--exec pr_egis_relatorio_analise_bonificacoes 183,4253,0,''
------------------------------------------------------------------------------
