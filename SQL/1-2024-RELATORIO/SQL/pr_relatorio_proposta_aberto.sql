IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_relatorio_proposta_aberto' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_relatorio_proposta_aberto

GO

-------------------------------------------------------------------------------
--sp_helptext pr_relatorio_proposta_aberto
-------------------------------------------------------------------------------
--pr_relatorio_proposta_aberto
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_relatorio_proposta_aberto
@cd_relatorio int   = 0,
@cd_parametro int   = 0, 
@json nvarchar(max) = '' 
...
select
  ...
  max(CAST(vl_total_consulta AS DECIMAL(18,2))) AS vl_total_consulta,
...
declare @vl_total_consulta           nvarchar(20)
...
------------------------------------------------------------------------------
--exec pr_relatorio_proposta_aberto 230,0,''
------------------------------------------------------------------------------
