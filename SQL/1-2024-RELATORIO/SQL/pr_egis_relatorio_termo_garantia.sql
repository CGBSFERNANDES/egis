IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_relatorio_termo_garantia' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_relatorio_termo_garantia

GO

-------------------------------------------------------------------------------
--sp_helptext pr_egis_relatorio_termo_garantia
-------------------------------------------------------------------------------
--pr_egis_relatorio_termo_garantia
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_egis_relatorio_termo_garantia
@cd_relatorio int   = 0,
@json nvarchar(max) = '' 
...
select
  ...
  DATEADD(DAY, 180, osc.dt_pagamento)    as garantia,
  --Cliente--
     ...
     <div class="container">
        <table class="header-table">
            ...
            <tr class="bold">
                ...
                <td colspan="2">GTIA Nº: '+cast(isnull(@cd_ordem_servico,'')as nvarchar(15))+'</td>
            </tr>
            <tr class="bold">
                <td colspan="3">
       ...
       <table >
           ...
           <tr>
                ...
                <td>'+isnull(@nm_contato_cliente,'')+'</td>
           </tr> 
...
------------------------------------------------------------------------------
--exec pr_egis_relatorio_termo_garantia 299,''