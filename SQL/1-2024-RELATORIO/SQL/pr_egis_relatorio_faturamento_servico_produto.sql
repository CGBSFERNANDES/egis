IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_relatorio_faturamento_servico_produto' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_relatorio_faturamento_servico_produto

GO

-------------------------------------------------------------------------------
--sp_helptext pr_egis_relatorio_faturamento_servico_produto
-------------------------------------------------------------------------------
--pr_egis_relatorio_faturamento_servico_produto
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_egis_relatorio_faturamento_servico_produto
@cd_relatorio int   = 0,
@cd_parametro int   = 0, 
@json nvarchar(max) = '' 
...
------------------------------------------------------------------------------------------------------------		 
 ...
 begin  
    select * from #FaturamentoProdutoServico  
  return  
 end  
...
select 
	...
	@qt_veiculo    = sum(qt_veiculo),
	@qt_entregador = sum(qt_entregador)
from #FaturamentoProdutoServico
--------------------------------------------------------------------------------------------------------------
set @html_geral = '
...
WHILE EXISTS (SELECT TOP 1 cd_controle FROM #FaturamentoProdutoServico)
BEGIN
    SELECT TOP 1
        @id                          = cd_controle,
	...
	FROM #FaturamentoProdutoServico
    DELETE FROM #FaturamentoProdutoServico WHERE cd_controle = @id
END
--------------------------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------
--exec pr_egis_relatorio_faturamento_servico_produto 345,0,''
------------------------------------------------------------------------------
