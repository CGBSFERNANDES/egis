IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_relatorio_diario_vendas' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_relatorio_diario_vendas

GO

-------------------------------------------------------------------------------
--sp_helptext pr_relatorio_diario_vendas
-------------------------------------------------------------------------------
--pr_relatorio_diario_vendas
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_relatorio_diario_vendas
@cd_relatorio int   = 0,
@cd_parametro int   = 0, 
@json nvarchar(max) = '' 
...
as
print 'iniciou a pr_relatorio_diario_vendas'
...
from  
 pedido_venda p  
  ...
  left outer join cidade cid                on cid.cd_pais                  = c.cd_pais  
...
set @html_geral = '   
     <div class="section-title">  
        ...
        <p style="display: inline; text-align: center; padding: 25%;">Diário de Vendas</p>  
    </div>  
	<div>
    <table>
      <tr class="tamanho">
...
------------------------------------------------------------------------------
--exec pr_relatorio_diario_vendas 281,0,''
------------------------------------------------------------------------------
