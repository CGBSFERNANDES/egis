IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_relatorio_faturamento_mensal_veiculo' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_relatorio_faturamento_mensal_veiculo

GO

-------------------------------------------------------------------------------
--sp_helptext pr_egis_relatorio_faturamento_mensal_veiculo
-------------------------------------------------------------------------------
--pr_egis_relatorio_faturamento_mensal_veiculo
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_egis_relatorio_faturamento_mensal_veiculo
@cd_relatorio int   = 0,
@cd_parametro int   = 0, 
@json nvarchar(max) = '' 
...
------------------------------------------------------------------------------------------------------------		 
 ...
 begin  
    select * from #faturamentoVeiculo  
  return  
 end  
...
WHILE EXISTS (SELECT TOP 1 cd_controle FROM #faturamentoVeiculo)
BEGIN
    SELECT TOP 1
        @id                          = cd_controle,
	...
	FROM #faturamentoVeiculo
    DELETE FROM #faturamentoVeiculo WHERE cd_controle = @id
END
--------------------------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------
--exec pr_egis_relatorio_faturamento_mensal_veiculo 345,0,''
------------------------------------------------------------------------------
