IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_relatorio_monitoramento_visitas' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_relatorio_monitoramento_visitas

GO

-------------------------------------------------------------------------------
--sp_helptext pr_egis_relatorio_monitoramento_visitas
-------------------------------------------------------------------------------
--pr_egis_relatorio_monitoramento_visitas
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_egis_relatorio_monitoramento_visitas
@cd_relatorio int   = 0,
@cd_usuario   int   = 0,
@cd_parametro int   = 0,
@json nvarchar(max) = '' 
...
---Monitoramento de Visitas---------------------------------------------------
  ...
  from
    Visita v
	inner join Cliente c         on c.cd_cliente         = v.cd_cliente
...
------------------------------------------------------------------------------
--Gráfico
exec pr_egis_relatorio_monitoramento_visitas 179,4253,0,''
------------------------------------------------------------------------------
