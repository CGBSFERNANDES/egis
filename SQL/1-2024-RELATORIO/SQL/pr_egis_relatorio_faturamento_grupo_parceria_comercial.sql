IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_relatorio_faturamento_grupo_parceria_comercial' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_relatorio_faturamento_grupo_parceria_comercial

GO

-------------------------------------------------------------------------------
--sp_helptext pr_egis_relatorio_faturamento_grupo_parceria_comercial
-------------------------------------------------------------------------------
--pr_egis_relatorio_faturamento_grupo_parceria_comercial
-------------------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
create procedure pr_egis_relatorio_faturamento_grupo_parceria_comercial
@cd_relatorio int   = 0,
@cd_usuario   int   = 0,
@cd_parametro int   = 0,
@json nvarchar(max) = '' 
...
---------------------------------------------------------------------------------------------------------------------------
--select @nm_grupo_relatorio, @nm_grupo
...
<div class="secao4" id="sobre">
  <div class="secao4-div">
      ...
      <div class="secao4-div-card">   
          ...
          <p> '+'R$ '+dbo.fn_formata_valor(isnull(@vl_total,0))+'</p>
      </div>
...
------------------------------------------------------------------------------
exec pr_egis_relatorio_faturamento_grupo_parceria_comercial 193,4253,0,''
------------------------------------------------------------------------------
