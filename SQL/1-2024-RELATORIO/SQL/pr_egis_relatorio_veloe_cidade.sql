IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pr_egis_relatorio_veloe_cidade' 
	   AND 	  type = 'P')
    DROP PROCEDURE pr_egis_relatorio_veloe_cidade

GO
  
-------------------------------------------------------------------------------  
--sp_helptext pr_egis_relatorio_veloe_cidade  
-------------------------------------------------------------------------------  
--pr_egis_relatorio_veloe_cidade  
-------------------------------------------------------------------------------  
...
--  
------------------------------------------------------------------------------  
create procedure pr_egis_relatorio_veloe_cidade
@cd_relatorio int   = 0,  
@cd_parametro int   = 0,  
@json nvarchar(max) = ''   
...
WHILE EXISTS (SELECT TOP 1 cd_controle FROM #VeloeCidade)  
BEGIN  
    SELECT TOP 1  
        @id                          = cd_controle,  
	...
	FROM
	  #VeloeCidade  
    DELETE FROM #VeloeCidade WHERE cd_controle = @id  
END  
--------------------------------------------------------------------------------------------------------------------  
...
--exec pr_egis_relatorio_veloe_cidade 305,0,''